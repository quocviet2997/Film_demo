...
<body onload="loadFilm()">
  <%@ include file="/common/web/header.jsp"%>
      <div class="container">
        ...
        <h2>Kết quả tìm kiếm theo ${searchStr}</h2>
        ...
        <form action="<c:url value=''/>" id="formSubmit" method="get">
          ...
          <input type="hidden" value="<c:out value='${searchStr}' />" id="searchStr" name="searchStr"/>
        </form>
      </div>
  ...
  <script>
    function loadFilm(){
      ...
      loadUserInfo();
      showListGenre();
      showList(currentPage, limit, searchStr);
    }
    ...
    function showList(currentPage, limit, searchStr) {
      $.ajax({
        url: "${APIurl}",
        contentType: "application/json",
        method: "get",
        data: {page: currentPage, limit: limit, searchInfo: searchStr},
